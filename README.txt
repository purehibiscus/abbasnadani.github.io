...
Power BI, SQL
https://github.com/purehibiscus/OlistStore2018SalesAnalysiswithMSPowerBI 

Global Ride-Sharing Analytics Dashboard 
Interactive dashboard tracking revenue, ride demand, driver performance, and customer retention. 
Power BI, Power Query, DAX 
https://github.com/purehibiscus/GlobalRideSharingAnalysiswithPowerQueryPowerBIdatamodelingDAXandPowerBIreports 

Adidas Retail Sales Dashboard
Analyzed 9,648 transactions for revenue drivers, product trends, and regional insights. 
Excel, Power Query
https://github.com/purehibiscus/AdidasSalesAnalysisandDashboardwithMSExcel 

Retail Customer Analytics Dashboard 
KPI dashboards including total sales, repeat purchase rate, and subscriber revenue. 
Excel, PivotTables 
https://github.com/purehibiscus/SuperstoreSalesCustomerAnalyticsDashboard 


Customer & Product Analytics
Project | Description | Tools | Link 
Customer Churn Analysis 
Identified churn drivers and high-value segments, creating dashboards for actionable retention strategies. 
MySQL, Power BI, DAX 
GitHub: https://github.com/purehibiscus/SalesCustomerChurnAnalysis 

Digital Wallet LTV Analysis 
Customer lifetime value analysis for fintech platform; segmented users, identified churn risks, and modeled monetization. 
SQL Server, Power BI, Excel 
https://github.com/purehibiscus/FinTechCustomerLifetimeValueLTVBIAnalysiswithMSPowerBI

Ride-Hailing User Survey Analysis
Analyzed 130 survey responses to evaluate app preferences, safety, pricing, and usability. 
Power BI 
https://github.com/purehibiscus/RideAppsSurveyPakistanwithPowerBI 
Financial & SaaS Analytics

Project | Description | Tools | Link
SaaS Financial Analytics Dashboard 
GAAPaligned SaaS metrics including MRR, ARR, CAC, LTV, and Rule of 40; dashboards for leadership. 
Power BI, DAX 
https://github.com/purehibiscus/SaaSGAAPFinancialAnalysiswithPowerBI 

Financial Performance & Variance Analysis 
Executive dashboard for actual vs budget performance across multiple entities and accounts.
Power BI, DAX
...
Laptop Price Analysis & EDA 
Feature engineering, pricing segmentation, and exploratory analysis to inform product and market strategy. 
MySQL, SQL, Excel, Power BI 
...
Webpage A/B Testing Analysis
End-to-end A/B experiment evaluation for webpage conversion optimization with statistical significance testing.
Python, Statistics 
...
SQL Server, Power BI 
https://github.com/purehibiscus/GlobalHealthAnalysiswithSQLServerandPowerBI 

Malaria in Africa Analysis 
Trends in malaria incidence, infrastructure evaluation, and prevention measures across Africa. 
Power BI, DAX 
